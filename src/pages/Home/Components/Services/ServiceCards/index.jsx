...
const ServiceCards = ({ icon, title, description }) => {
  ...
  return (
    <>
      <div className="bg-white group hover:bg-primary transition-all ease-in duration-300 mt-[177px] border border-[rgba(0,0,0,0.08)] hover:border-primary rounded-[10px] p-[20px] text-center ">
